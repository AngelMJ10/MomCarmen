            ...
            <div class="card shadow-lg border-0">
                ...
                <form>
                    <div class="row mb-2 mt-2">
                        ...
                        <div class="col-md-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="bebida" name="precio" placeholder="Precio">
                    ...
                    <button type="button" id="registrar-bebida"  class="btn btn-outline-primary">Agregar</button>
                            ...
                            <div class="accordion-body">
                                <form>
                                    <div class="row mb-2 mt-2">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-floating mb-3">
                                                <input type="number" class="form-control" id="stock-buscar" name="precio" placeholder="Precio">
                                                <label for="precio" class="form-label">Stock</label>
                                            </div>
                                        </div>
            ...
            <div class="modal-body">
                <form>
                    <div class="row mb-2 mt-2">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="bebida-editar" name="precio" placeholder="Precio">
                                <label for="precio" class="form-label">Bebida</label>
                            </div>
                        </div>
                        <div class="col-md-4">
